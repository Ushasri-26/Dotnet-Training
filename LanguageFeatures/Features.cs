...
#pragma warning restore
        ...
        {//collection initilizer..
         ...
         //ob1.name = "Usha";
            ...
            List<student> s1 = new List<student>() { (new student() { studentId = 5, name = "Usha sri" }),
            (new student() { studentId=2,name="Uday Kiran"}),
            (new student() { studentId=3,name="Satwi"}),
            (new student() { studentId=4,name="Anurag"})};
